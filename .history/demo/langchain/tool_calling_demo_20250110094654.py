...
class ToolCallingDemo:
    def __init__(self, api_key: str = None):
        ...
        :param api_key: OpenAI API 密钥，如果未提供则从环境变量读取
        """
        import os
        ...
        # 初始化 LLM 并绑定工具
        self.llm = ChatOpenAI(model="gpt-4o-mini",base_url="https://api.deepseek.com",api_key="sk-00acc077d0d34f43a21910049163d796")
